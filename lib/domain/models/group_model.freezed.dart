...
mixin _$GroupModel {
  ...
  List<String> get memberIds =>
      throw _privateConstructorUsedError; // メンバーのユーザーIDリスト
...
class _$GroupModelImpl implements _GroupModel {
  ...
  @override
  String toString() {
    return 'GroupModel(id: $id, name: $name, memberIds: $memberIds, description: $description, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _GroupModel implements GroupModel {
  ...
  String get name;
  @override
  List<String> get memberIds; // メンバーのユーザーIDリスト
  @override
